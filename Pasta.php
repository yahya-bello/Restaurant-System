...
<body>
    <section class="Menu">
        ...
        <div class="cont"> <br>
            <h2 class="tocentertext"> HERE YOU CAN EXPLORE DIFFERENT TYPES OF PASTA </h2>
            <br>
            <?php
            ...
            ?>
                    ...
                    <div class="Menu1">
                        <div class="Menu1img">
                            ...
                            ?>
                                <img src="images/<?php echo $image_name; ?>" alt=" Cheese pasta" class="Menu1imgg imagecurve">
                        </div>
                         <?php
                            }
                        ?>
                         ...
                         <div class="Menu1descr">
                          ...
                          <br>
                          <a href="order_pasta.php?food_id=<?php echo $id; ?>" class="fai faid">Order now</a>
                    </div>
                    </div>
            <!-- </div> -->
